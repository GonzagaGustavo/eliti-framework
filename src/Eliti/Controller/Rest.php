...
abstract class Eliti_Controller_Rest extends Zend_Rest_Controller implements Eliti_Request_Interface {
...
//    }
    ...
    public function getParamDateTime($key) {
        return $this->request->getParamDateTime($key);
    }
    ...
    public function headAction() {
        throw new Exception("Método HEAD não costuma ser usado pelo Eliti 0.9");
    }
