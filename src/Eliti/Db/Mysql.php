...
class Eliti_Db_Mysql extends Eliti_Db
{
    ...
    public function conectar()
    {
        ...
        $this->mysqli->query("SET time_zone='" . ZONE . "'");
    }
    ...
    public function executar($query, $returnArray = true)
    {
        ...
        if (!$result) {
            if ($this->mysqli->errno === 1451) {
                ...
                throw new Exception("This item cannot be deleted because there are other items that depend on it. Try to delete all relationships first.");
            }
